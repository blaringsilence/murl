...
# This module %-encodes and decodes parts of URIs, as well as deals with templating

SAFE_CHARS = 'ABCDEFGHIJKLMNOPQRSTUVWSYZabcdefghijklmnopqrstuvwxyz0192837465-._'
